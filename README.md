...
> **🎉 UPGRADED TO TENSORFLOW 2.13+**  
> This fork has been upgraded to work with the latest TensorFlow 2.13+ and Python 3.8+.  
> **📖 See [UPGRADE_COMPLETE.md](UPGRADE_COMPLETE.md) for upgrade details and installation instructions.**  
> **🔍 See [MIGRATION_NOTES.md](MIGRATION_NOTES.md) for technical details of all changes.**

This repo let's you train a custom image detector using the state-of-the-art [YOLOv3](https://pjreddie.com/darknet/yolo/) computer vision algorithm. For a short write up check out this [medium post](https://medium.com/@muehle/how-to-train-your-own-yolov3-detector-from-scratch-224d10e55de2). This repo now works with **TensorFlow 2.13+** (upgraded from TensorFlow 2.3 and Keras 2.4).
...
The only hard requirement is a running version of **Python 3.8 or later**. To install the latest Python go to

- [python.org/downloads](https://www.python.org/downloads/)

and follow the installation instructions. Note that this upgraded repo requires **Python 3.8+** and has been tested with Python 3.13. It is recommended to use **Python 3.10 or later** for best compatibility with TensorFlow 2.13+.
...
3. If you have an older version of Python on your system, make sure you upgrade to Python 3.8 or later. You can use virtualenv to specify the Python version:
   ```
   pip install virtualenv
   virtualenv env --python=python3.10  # or python3.11, python3.12, etc.
   ```
   Then follow the same steps as above. **Note**: This upgraded repo requires Python 3.8+ and TensorFlow 2.13+.
